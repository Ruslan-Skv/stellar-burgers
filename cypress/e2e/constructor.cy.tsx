...
// Селекторы
const SELECTORS = {
  NO_BUN_1: '[data-cy=no_bun_text_1]',
  NO_BUN_2: '[data-cy=no_bun_text_2]',
  NO_INGREDIENTS: '[data-cy=no_ingredients_text]',
  BUN: '[data-cy=bun_0] button',
  INGREDIENT: '[data-cy=ingredient_0] button',
  CONSTRUCTOR: '[data-cy=constructor_section]',
  INGREDIENT_ELEMENT: '[data-cy=ingredient_element]',
  INGREDIENT_MODAL: '[data-cy=ingredient_modal]',
  MODAL_CLOSE: '[data-cy=close_modal_btn]',
  ORDER_BUTTON: '[data-cy=new_order_total] button',
  ORDER_NUMBER: '[data-cy=new_order_number]'
};
